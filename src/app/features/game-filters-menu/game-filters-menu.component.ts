...
export class GameFiltersMenuComponent implements OnChanges {
  ...
  readonly statusOptions: GameStatusFilterOption[] = [
    'none',
    'playing',
    'wantToPlay',
    'completed',
  ...
  onRatingSelectionChange(
    value: GameRatingFilterOption[] | GameRatingFilterOption | null | undefined
  ): void {
  ...
  private normalizeStatusSelection(
    value: GameStatusFilterOption[] | GameStatusFilterOption | null | undefined
  ): GameStatusFilterOption[] {
  ...
  private normalizeRatingSelection(
    value: GameRatingFilterOption[] | GameRatingFilterOption | null | undefined
  ): GameRatingFilterOption[] {
    const normalizedValues = Array.isArray(value)
      ? value
