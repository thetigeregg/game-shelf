...
describe('GameSyncService', () => {
  ...
  it('treats invalid enteredCollectionAt values on sync pulls as null instead of coercing them to now', async () => {
    ...
    await servicePrivate.applyGameChange({
      ...
      payload: createBaseGame({
        ...
        enteredCollectionAt: 'not-a-real-timestamp',
      }),
  ...
  it('treats non-string enteredCollectionAt values on sync pulls as null instead of coercing them to now', async () => {
    ...
    await servicePrivate.applyGameChange({
      ...
      payload: createBaseGame({
        ...
        enteredCollectionAt: 1711929600000,
      }),
      serverTimestamp: '2026-05-01T00:00:00.000Z',
    });
  ...
  it('trims wishlist listType values on sync pulls before clearing enteredCollectionAt', async () => {
    await db.games.put({
      igdbGameId: '123',
      platformIgdbId: 130,
      title: 'Stored',
    ...
    await servicePrivate.applyGameChange({
      ...
      serverTimestamp: '2026-02-02T00:00:00.000Z',
    });
