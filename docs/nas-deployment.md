...
- `RELEASE_MONITOR_JOB_CONCURRENCY` (optional; defaults `2`; consumed by `background-worker`)
...
- `RECOMMENDATIONS_SCHEDULER_ENABLED` (optional; defaults `true`; consumed by `background-worker`)
- `RECOMMENDATIONS_JOB_CONCURRENCY` (optional; defaults `1`; consumed by `background-worker`)
- `DISCOVERY_ENRICHMENT_JOB_CONCURRENCY` (optional; defaults `1`; consumed by `background-worker`)
...
- `METADATA_ENRICHMENT_JOB_CONCURRENCY` (optional; default `1`; consumed by `background-worker`)
- `METADATA_ENRICHMENT_QUEUE_INTERVAL_MINUTES` (optional; default `60`; consumed by `background-worker`)
...
- `BACKGROUND_JOB_LOCK_HEARTBEAT_SECONDS` (optional; default `30`; consumed by `background-worker`)
